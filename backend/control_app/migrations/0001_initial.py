    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        verbose_name="¿Acepta Notificación Electrónica?"
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="Build Area Id+",
                        to="control_app.buildarea",
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.DO_NOTHING,
                        related_name="Housing Type Id+",
                        to="control_app.housingtype",
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.DO_NOTHING,
                        related_name="Materiality Id+",
                        to="control_app.materiality",
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.DO_NOTHING,
                        related_name="Medida o mecanismo+",
                        to="control_app.measure",
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("name", models.CharField(max_length=50)),
                (
                    "br_document_typeProcedure_modality",
                    models.ManyToManyField(
                        blank=True,
                        through="control_app.BrDocumentTypeProcedureModality",
                        to="control_app.document",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.DO_NOTHING,
                        related_name="Modality Id+",
                        to="control_app.modality",
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "br_request_commercialType",
                    models.ManyToManyField(
                        blank=True,
                        through="control_app.BrRequestCommercialType",
                        to="control_app.commercialtype",
                    ),
                ),
                (
                    "br_request_institutionalType",
                    models.ManyToManyField(
                        blank=True,
                        through="control_app.BrRequestInstitutionalType",
                        to="control_app.institutionaltype",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.DO_NOTHING,
                        related_name="Planimetry Id+",
                        to="control_app.planimetry",
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.DO_NOTHING,
                        related_name="Procedure Objective Id+",
                        to="control_app.procedureobjective",
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("identification_num", models.CharField(max_length=30)),
                (
                    "professional_licence_num",
                    models.CharField(max_length=30, verbose_name="Prof Lic Num"),
                ),
                ("licence_expedition", models.DateField()),
                ("email", models.EmailField(max_length=40)),
                (
                    "required_review",
                    models.BooleanField(verbose_name="¿Exige Supervisión Tecnica?"),
                ),
                ("sign", models.BooleanField(verbose_name="Firma")),
                (
                    "profession_name_id",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.DO_NOTHING,
                        related_name="Profession Name+",
                        to="control_app.professionname",
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "br_property_planimetry",
                    models.ManyToManyField(
                        blank=True,
                        through="control_app.BrPropertyPlanimetry",
                        to="control_app.planimetry",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "br_procedure_objective",
                    models.ManyToManyField(
                        blank=True,
                        through="control_app.BrRequestProcedureObjective",
                        to="control_app.procedureobjective",
                    ),
                ),
                (
                    "br_request_buildArea",
                    models.ManyToManyField(
                        blank=True,
                        through="control_app.BrRequestBuildArea",
                        to="control_app.buildarea",
                    ),
                ),
                (
                ...
                (
                    "br_request_housingType",
                    models.ManyToManyField(
                        blank=True,
                        through="control_app.BrRequestHousingType",
                        to="control_app.housingtype",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("name", models.CharField(max_length=50)),
                (
                    "br_property_soilClasification",
                    models.ManyToManyField(
                        blank=True,
                        through="control_app.BrPropertySoilClasification",
                        to="control_app.property",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        through="control_app.BrSustainableDeclarationMateriality",
                        to="control_app.materiality",
                    ),
                ),
                (
                    "br_sustainable_measure",
                    models.ManyToManyField(
                        blank=True,
                        through="control_app.BrSustainableDeclarationMeasure",
                        to="control_app.measure",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        through="control_app.BrRequestTypeProcedure",
                        to="control_app.request",
                    ),
                ),
                (
                    "br_typeProcedure_modality",
                    models.ManyToManyField(
                        blank=True,
                        through="control_app.BrTypeProcedureModality",
                        to="control_app.modality",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "br_uniqueNatForm_Neighbor",
                    models.ManyToManyField(
                        blank=True,
                        through="control_app.BrUniqueNationalFormNeighbor",
                        to="control_app.neighbor",
                    ),
                ),
                (
                ...
                (
                    "petition_responsible",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="control_app.petitionresponsible",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        through="control_app.BrRequestUses",
                        to="control_app.request",
                    ),
                ),
            ],
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, through="control_app.BrRequestUses", to="control_app.uses"
            ),
        ),
        migrations.AddField(
            model_name="otherdetail",
        ...
        migrations.AlterUniqueTogether(
            name="brrequestprocedureobjective",
            unique_together={
                ("request_id", "procedure_objective_id", "other_detail_id")
            },
        ),
        migrations.AlterUniqueTogether(
            name="brrequestinstitutionaltype",
            unique_together={
                ("request_id", "institutional_type_id", "other_detail_id")
            },
        ),
        migrations.AlterUniqueTogether(
            name="brrequesthousingtype",
